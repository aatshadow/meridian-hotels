          ...
          <div className="col-span-2 md:col-span-1">
            <span className="inline-flex items-center gap-3">
              ...
              <span className="flex flex-col leading-none">
                <span className="font-display text-xl font-semibold tracking-[0.14em] text-cream">PRIMO</span>
      ...
      <div className="border-t border-cream/10">
        <div className="mx-auto flex max-w-[1400px] flex-col items-center justify-between gap-3 px-6 py-7 md:flex-row md:px-10">
          <span className="data-label text-xs text-cream/40">
            © {new Date().getFullYear()} PRIMO · {t(HOTEL.town)} — {t(C.ui.rights)}
          </span>
          <span className="data-label text-xs text-cream/40">Hotel Primo · Primorsko</span>
        </div>
      </div>
    </footer>
  );
