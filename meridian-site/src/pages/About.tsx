...
const PRINCIPLES = [
  {
    ...
    body: "Всичко е изградено да спечели резервацията за хотела — а не да я препраща през посредник, който държи госта за себе си.",
  },
  {
    no: "02",
    title: "Органично, не платено",
    body: "Обхват, който се натрупва седмица след седмица, без рекламен бюджет, който да го крепи. Над десет милиона гледания, без платена реклама.",
  },
  {
    no: "03",
